        ...
        for (point, response) in self.known_requests:
            for dupe in dupes:
                ...
                for feature in response['features']:
                    if dupe['type'] == feature['type'] and dupe['category'] == feature['category'] and dupe['subcategory'] == feature['subcategory']:
                        instances_found += 1
...
EXPECTED_RESPONSES = {
 ...
 'timestamp': Decimal('1291850896.369'),
 'weather': {'temperature': '57F'}},
 ...
 'timestamp': Decimal('1291851165.045'),
 'weather': {'temperature': '57F'}},
 ...
 'timestamp': Decimal('1291851315.129'),
 'weather': {'temperature': '46F'}}
}
